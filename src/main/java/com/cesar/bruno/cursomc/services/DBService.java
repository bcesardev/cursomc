...
import com.cesar.bruno.cursomc.domain.Estado;
import com.cesar.bruno.cursomc.domain.ItemPedido;
import com.cesar.bruno.cursomc.domain.Pagamento;
import com.cesar.bruno.cursomc.domain.PagamentoComBoleto;
import com.cesar.bruno.cursomc.domain.PagamentoComCartao;
...
import com.cesar.bruno.cursomc.domain.enums.Perfil;
import com.cesar.bruno.cursomc.domain.enums.TipoCliente;
import com.cesar.bruno.cursomc.repositories.CategoriaRepository;
import com.cesar.bruno.cursomc.repositories.CidadeRepository;
import com.cesar.bruno.cursomc.repositories.ClienteRepository;
import com.cesar.bruno.cursomc.repositories.EnderecoRepository;
import com.cesar.bruno.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "bcesar.bruno@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costas", "bruno.depaula@diadeis.com", "91053040679", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("955552222", "43211555"));
		cli2.addPerfil(Perfil.ADMIN);		

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "06417000", cli2, c2);
